...
* [Spring hu.oliver.tesztfeladatweblap.Security](https://docs.spring.io/spring-boot/docs/2.7.2/reference/htmlsingle/#web.security)
...
* [Building a RESTful Web hu.oliver.tesztfeladatweblap.Service](https://spring.io/guides/gs/rest-service/)
